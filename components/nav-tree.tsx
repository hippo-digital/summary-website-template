...
const isCurrentPageInChildren = (routerPath: string, children: Tree<Metadata>[]): boolean => {
...
const PageNode = ({ node }: { node: Tree<Metadata> }) => {
    ...
    const isCurrentPage = isNodeCurrentPage(router.asPath, node.current.entry.slug);
